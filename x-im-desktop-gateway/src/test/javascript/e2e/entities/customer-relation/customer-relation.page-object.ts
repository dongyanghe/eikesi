...
export class CustomerRelationComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    title = element.all(by.css('jhi-customer-relation div h2#page-heading span')).first();
...
export class CustomerRelationUpdatePage {
    pageTitle = element(by.id('jhi-customer-relation-heading'));
