...
describe('CustomerRelation e2e test', () => {
    ...
    it('should load CustomerRelations', () => {
        ...
        expect(customerRelationComponentsPage.getTitle()).toMatch(/imGatewayApp.customerRelation.home.title/);
    });
    ...
    it('should load create CustomerRelation page', () => {
        ...
        expect(customerRelationUpdatePage.getPageTitle()).toMatch(/imGatewayApp.customerRelation.home.createOrEditLabel/);
