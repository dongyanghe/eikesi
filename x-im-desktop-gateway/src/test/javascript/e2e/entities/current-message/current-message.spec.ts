...
describe('CurrentMessage e2e test', () => {
    ...
    it('should load CurrentMessages', () => {
        ...
        expect(currentMessageComponentsPage.getTitle()).toMatch(/imGatewayApp.currentMessage.home.title/);
    });
    ...
    it('should load create CurrentMessage page', () => {
        ...
        expect(currentMessageUpdatePage.getPageTitle()).toMatch(/imGatewayApp.currentMessage.home.createOrEditLabel/);
