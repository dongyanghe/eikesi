...
describe('CustomerFlock e2e test', () => {
    ...
    it('should load CustomerFlocks', () => {
        ...
        expect(customerFlockComponentsPage.getTitle()).toMatch(/imGatewayApp.customerFlock.home.title/);
    });
    ...
    it('should load create CustomerFlock page', () => {
        ...
        expect(customerFlockUpdatePage.getPageTitle()).toMatch(/imGatewayApp.customerFlock.home.createOrEditLabel/);
