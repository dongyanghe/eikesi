...
import { HistoryMessageComponent } from 'app/entities/history-message/history-message.component';
...
describe('Component Tests', () => {
    describe('HistoryMessage Management Component', () => {
        let comp: HistoryMessageComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(HistoryMessageComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.historyMessages[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
