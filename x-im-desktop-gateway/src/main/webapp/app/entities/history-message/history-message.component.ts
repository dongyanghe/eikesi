...
export class HistoryMessageComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.historyMessageService
                ...
                .subscribe(
                    (res: HttpResponse<IHistoryMessage[]>) => this.paginateHistoryMessages(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/history-message'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    ngOnInit() {
        ...
        this.registerChangeInHistoryMessages();
    }
    ...
    trackId(index: number, item: IHistoryMessage) {
        return item.id;
    }

    registerChangeInHistoryMessages() {
        this.eventSubscriber = this.eventManager.subscribe('historyMessageListModification', response => this.loadAll());
    }
