package com.eikesi.gateway;

import com.eikesi.gateway.config.ApplicationProperties;
import com.eikesi.gateway.config.DefaultProfileUtil;
...
@EnableZuulProxy
@EnableFeignClients(basePackages={"com.eikesi.gateway"})
