...
import com.eikesi.customer.service.repository.CustomerRelationRepository;
import com.eikesi.customer.service.service.CustomerRelationService;
import com.eikesi.customer.service.service.dto.CustomerRelationDTO;
import com.eikesi.customer.service.service.mapper.CustomerRelationMapper;
...
public class CustomerRelationResourceIntTest {
    ...
    public void updateCustomerRelation() throws Exception {
        ...
        CustomerRelation updatedCustomerRelation = customerRelationRepository.findOne(customerRelation.getId());
    ...
    public void updateNonExistingCustomerRelation() throws Exception {
        ...
        // Validate the CustomerRelation in the database
        List<CustomerRelation> customerRelationList = customerRelationRepository.findAll();
        assertThat(customerRelationList).hasSize(databaseSizeBeforeUpdate + 1);
    }
