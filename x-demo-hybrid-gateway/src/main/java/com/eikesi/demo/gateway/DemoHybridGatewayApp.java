package com.eikesi.demo.gateway;
...
@EnableZuulProxy
public class DemoHybridGatewayApp {

    private static final Logger log = LoggerFactory.getLogger(DemoHybridGatewayApp.class);

    private final Environment env;

    public DemoHybridGatewayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes demoHybridGateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(DemoHybridGatewayApp.class);
