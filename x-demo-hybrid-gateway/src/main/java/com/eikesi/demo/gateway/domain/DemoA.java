...
public class DemoA implements Serializable {
    ...
    @Column(name = "date_time_when", nullable = false)
    private Instant dateTimeWhen;
    ...
    public Instant getDateTimeWhen() {
        return dateTimeWhen;
    }

    public DemoA dateTimeWhen(Instant dateTimeWhen) {
        this.dateTimeWhen = dateTimeWhen;
        return this;
    }

    public void setDateTimeWhen(Instant dateTimeWhen) {
        this.dateTimeWhen = dateTimeWhen;
    }
