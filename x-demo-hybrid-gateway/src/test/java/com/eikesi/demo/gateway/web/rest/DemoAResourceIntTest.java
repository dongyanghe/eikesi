...
import com.eikesi.demo.gateway.domain.DemoA;
import com.eikesi.demo.gateway.repository.DemoARepository;
import com.eikesi.demo.gateway.service.DemoAService;
import com.eikesi.demo.gateway.service.dto.DemoADTO;
import com.eikesi.demo.gateway.service.mapper.DemoAMapper;
...
import static com.eikesi.demo.gateway.web.rest.TestUtil.sameInstant;
...
import com.eikesi.demo.gateway.domain.enumeration.Language;
/**
...
public class DemoAResourceIntTest {
    ...
    private static final Instant DEFAULT_DATE_TIME_WHEN = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATE_TIME_WHEN = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static DemoA createEntity(EntityManager em) {
        DemoA demoA = new DemoA()
            ...
            .dateTimeWhen(DEFAULT_DATE_TIME_WHEN)
    ...
    public void createDemoA() throws Exception {
        ...
        assertThat(testDemoA.getDateTimeWhen()).isEqualTo(DEFAULT_DATE_TIME_WHEN);
    ...
    @Test
    @Transactional
    public void checkDateTimeWhenIsRequired() throws Exception {
        int databaseSizeBeforeTest = demoARepository.findAll().size();
        // set the field null
        demoA.setDateTimeWhen(null);
    ...
    public void getAllDemoAS() throws Exception {
        ...
        restDemoAMockMvc.perform(get("/api/demo-as?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dateTimeWhen").value(hasItem(DEFAULT_DATE_TIME_WHEN.toString())))
    ...
    public void getDemoA() throws Exception {
        ...
        restDemoAMockMvc.perform(get("/api/demo-as/{id}", demoA.getId()))
            ...
            .andExpect(jsonPath("$.dateTimeWhen").value(DEFAULT_DATE_TIME_WHEN.toString()))
    ...
    public void updateDemoA() throws Exception {
        ...
        updatedDemoA
            ...
            .dateTimeWhen(UPDATED_DATE_TIME_WHEN)
        ...
        assertThat(testDemoA.getDateTimeWhen()).isEqualTo(UPDATED_DATE_TIME_WHEN);
