package com.eikesi.abcd.config.timezone;

import com.eikesi.abcd.AbcdApp;
import com.eikesi.abcd.config.SecurityBeanOverrideConfiguration;
import com.eikesi.abcd.repository.timezone.DateTimeWrapper;
import com.eikesi.abcd.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@EmbeddedKafka
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, AbcdApp.class})
