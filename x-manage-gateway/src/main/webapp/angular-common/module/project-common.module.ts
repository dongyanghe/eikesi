...
@NgModule({
    imports: [CheckboxModule, RadioButtonModule, TreeModule, TreeTableModule, ContextMenuModule, SelectClassModule, SharedModule],
    declarations: [DynamicFormComponent, FlowchartComponent, Datepicker],
    exports: [DynamicFormComponent, FlowchartComponent, Datepicker, TreeTableModule, ContextMenuModule],
    providers: []
