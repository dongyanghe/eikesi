...
import { getEntity, deleteEntity } from 'app/entities/customer/customer.reducer';
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>
          <Translate contentKey="imWebGatewayApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>
