...
import { getSearchEntities, getEntities } from 'app/entities/history-message/history-message.reducer';
    ...
    return (
      <div>
        <h2 id="history-message-heading">
          <Translate contentKey="imWebGatewayApp.historyMessage.home.title">History Messages</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="imWebGatewayApp.historyMessage.home.createLabel">Create new History Message</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('imWebGatewayApp.historyMessage.home.search')}
                  />
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('content')}>
                  <Translate contentKey="imWebGatewayApp.historyMessage.content">Content</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('status')}>
                  <Translate contentKey="imWebGatewayApp.historyMessage.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={this.sort('createdId')}>
                  <Translate contentKey="imWebGatewayApp.historyMessage.createdId">Created Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('targetDate')}>
                  <Translate contentKey="imWebGatewayApp.historyMessage.targetDate">Target Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('targetId')}>
                  <Translate contentKey="imWebGatewayApp.historyMessage.targetId">Target Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
