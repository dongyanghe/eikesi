package com.eikesi.connect.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("connectCenter");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("connectCenter");
        ...
        config.getMapConfigs().put("com.eikesi.connect.domain.*", initializeDomainMapConfig(jHipsterProperties));
