...
import { getEntity } from 'app/entities/customer-flock/customer-flock.reducer';
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="imWebGatewayApp.customerFlock.detail.title">CustomerFlock</Translate> [<b>{customerFlockEntity.id}</b>]
          </h2>
