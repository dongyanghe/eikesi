...
import { getEntity, updateEntity, createEntity, reset } from 'app/entities/customer/customer.reducer';
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="imWebGatewayApp.customer.home.createOrEditLabel">
              <Translate contentKey="imWebGatewayApp.customer.home.createOrEditLabel">Create or edit a Customer</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
