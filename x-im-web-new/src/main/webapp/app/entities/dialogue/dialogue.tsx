...
import { getSearchEntities, getEntities } from 'app/entities/dialogue/dialogue.reducer';
    ...
    return (
      <div>
        <h2 id="dialogue-heading">
          <Translate contentKey="imWebGatewayApp.dialogue.home.title">Dialogues</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="imWebGatewayApp.dialogue.home.createLabel">Create new Dialogue</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('imWebGatewayApp.dialogue.home.search')}
                  />
