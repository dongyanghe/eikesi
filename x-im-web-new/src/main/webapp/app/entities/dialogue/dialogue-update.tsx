...
import { getEntity, updateEntity, createEntity, reset } from 'app/entities/dialogue/dialogue.reducer';
import { IDialogue } from 'app/shared/model/dialogue.model';
// tslint:disable-next-line:no-unused-variable
import { convertDateTimeFromServer } from 'app/shared/util/date-utils';
// import { keysToValues } from 'app/shared/util/entity-utils';

export interface IDialogueUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string}> {}
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="imWebGatewayApp.dialogue.home.createOrEditLabel">
              <Translate contentKey="imWebGatewayApp.dialogue.home.createOrEditLabel">Create or edit a Dialogue</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : dialogueEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="createdDateLabel" for="createdDate">
                    <Translate contentKey="imWebGatewayApp.dialogue.createdDate">Created Date</Translate>
                  </Label>
                  <AvInput
                  ...
                  <UncontrolledTooltip target="createdDateLabel">
                    <Translate contentKey="imWebGatewayApp.dialogue.help.createdDate" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="createdIdLabel" for="createdId">
                    <Translate contentKey="imWebGatewayApp.dialogue.createdId">Created Id</Translate>
                  </Label>
                  <AvField
                  ...
                  <UncontrolledTooltip target="createdIdLabel">
                    <Translate contentKey="imWebGatewayApp.dialogue.help.createdId" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="targetIdLabel" for="targetId">
                    <Translate contentKey="imWebGatewayApp.dialogue.targetId">Target Id</Translate>
                  </Label>
                  <AvField
                  ...
                  <UncontrolledTooltip target="targetIdLabel">
                    <Translate contentKey="imWebGatewayApp.dialogue.help.targetId" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="targetTypeLabel" for="targetType">
                    <Translate contentKey="imWebGatewayApp.dialogue.targetType">Target Type</Translate>
                  </Label>
                  <AvField
                  ...
                  <UncontrolledTooltip target="targetTypeLabel">
                    <Translate contentKey="imWebGatewayApp.dialogue.help.targetType" />
                  </UncontrolledTooltip>
                </AvGroup>
