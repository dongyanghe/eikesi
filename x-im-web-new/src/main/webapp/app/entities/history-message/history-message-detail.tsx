...
import { getEntity } from 'app/entities/history-message/history-message.reducer';
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="imWebGatewayApp.historyMessage.detail.title">HistoryMessage</Translate> [<b>{historyMessageEntity.id}</b>
            ]
          </h2>
