...
import { getEntity, updateEntity, createEntity, reset } from 'app/entities/current-message/current-message.reducer';
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="imWebGatewayApp.currentMessage.home.createOrEditLabel">
              <Translate contentKey="imWebGatewayApp.currentMessage.home.createOrEditLabel">Create or edit a CurrentMessage</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
