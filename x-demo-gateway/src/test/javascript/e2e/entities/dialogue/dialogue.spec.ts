...
describe('Dialogue e2e test', () => {
    ...
    it('should load Dialogues', () => {
        ...
        expect(dialogueComponentsPage.getTitle()).toMatch(/demoGatewayApp.dialogue.home.title/);
    });

    it('should load create Dialogue page', () => {
        dialogueComponentsPage.clickOnCreateButton();
        dialogueUpdatePage = new DialogueUpdatePage();
        expect(dialogueUpdatePage.getPageTitle()).toMatch(/demoGatewayApp.dialogue.home.createOrEditLabel/);
