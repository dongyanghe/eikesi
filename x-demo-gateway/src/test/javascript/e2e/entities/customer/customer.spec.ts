...
describe('Customer e2e test', () => {
    ...
    it('should load Customers', () => {
        ...
        expect(customerComponentsPage.getTitle()).toMatch(/demoGatewayApp.customer.home.title/);
    });

    it('should load create Customer page', () => {
        customerComponentsPage.clickOnCreateButton();
        customerUpdatePage = new CustomerUpdatePage();
        expect(customerUpdatePage.getPageTitle()).toMatch(/demoGatewayApp.customer.home.createOrEditLabel/);
