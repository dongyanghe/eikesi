...
describe('HistoryMessage e2e test', () => {
    ...
    it('should load HistoryMessages', () => {
        ...
        expect(historyMessageComponentsPage.getTitle()).toMatch(/demoGatewayApp.historyMessage.home.title/);
    });
    ...
    it('should load create HistoryMessage page', () => {
        ...
        expect(historyMessageUpdatePage.getPageTitle()).toMatch(/demoGatewayApp.historyMessage.home.createOrEditLabel/);
