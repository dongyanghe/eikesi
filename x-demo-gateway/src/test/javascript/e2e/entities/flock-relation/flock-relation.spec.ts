...
describe('FlockRelation e2e test', () => {
    ...
    it('should load FlockRelations', () => {
        ...
        expect(flockRelationComponentsPage.getTitle()).toMatch(/demoGatewayApp.flockRelation.home.title/);
    });
    ...
    it('should load create FlockRelation page', () => {
        ...
        expect(flockRelationUpdatePage.getPageTitle()).toMatch(/demoGatewayApp.flockRelation.home.createOrEditLabel/);
