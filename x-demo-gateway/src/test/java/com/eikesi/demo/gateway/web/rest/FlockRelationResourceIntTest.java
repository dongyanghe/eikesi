...
import com.eikesi.demo.gateway.DemoGatewayApp;

import com.eikesi.demo.gateway.config.SecurityBeanOverrideConfiguration;

import com.eikesi.demo.gateway.domain.FlockRelation;
import com.eikesi.demo.gateway.repository.FlockRelationRepository;
import com.eikesi.demo.gateway.repository.search.FlockRelationSearchRepository;
...
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, DemoGatewayApp.class})
public class FlockRelationResourceIntTest {
    ...
    /**
     * This repository is mocked in the com.eikesi.demo.gateway.repository.search test package.
     *
     * @see com.eikesi.demo.gateway.repository.search.FlockRelationSearchRepositoryMockConfiguration
     */
    @Autowired
