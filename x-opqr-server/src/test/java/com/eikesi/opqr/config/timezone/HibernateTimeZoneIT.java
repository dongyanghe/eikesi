package com.eikesi.opqr.config.timezone;

import com.eikesi.opqr.OpqrApp;
import com.eikesi.opqr.config.SecurityBeanOverrideConfiguration;
import com.eikesi.opqr.repository.timezone.DateTimeWrapper;
import com.eikesi.opqr.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@EmbeddedKafka
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, OpqrApp.class})
