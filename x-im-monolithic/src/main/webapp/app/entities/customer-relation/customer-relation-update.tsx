...
export interface ICustomerRelationUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="imApp.customerRelation.home.createOrEditLabel">
              <Translate contentKey="imApp.customerRelation.home.createOrEditLabel">Create or edit a CustomerRelation</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : customerRelationEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <UncontrolledTooltip target="remarkNameLabel">
                    <Translate contentKey="imApp.customerRelation.help.remarkName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  ...
                  <UncontrolledTooltip target="pyLabel">
                    <Translate contentKey="imApp.customerRelation.help.py" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  ...
                  <UncontrolledTooltip target="pinYinLabel">
                    <Translate contentKey="imApp.customerRelation.help.pinYin" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  ...
                  <UncontrolledTooltip target="typeLabel">
                    <Translate contentKey="imApp.customerRelation.help.type" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  ...
                  <UncontrolledTooltip target="createdDateLabel">
                    <Translate contentKey="imApp.customerRelation.help.createdDate" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  ...
                  <AvInput id="customer-relation-customer" type="select" className="form-control" name="customer.id">
                    <option value="" key="0" />
                    {customers
...
const mapStateToProps = (storeState: IRootState) => ({
  ...
  updateSuccess: storeState.customerRelation.updateSuccess
});
