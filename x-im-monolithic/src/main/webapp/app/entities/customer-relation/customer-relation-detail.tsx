  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="imApp.customerRelation.detail.title">CustomerRelation</Translate> [<b>{customerRelationEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>{customerRelationEntity.customer ? customerRelationEntity.customer.firstName : ''}</dd>
          </dl>
