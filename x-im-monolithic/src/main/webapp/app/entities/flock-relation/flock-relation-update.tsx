...
export interface IFlockRelationUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export interface IFlockRelationUpdateState {
  isNew: boolean;
  customerId: string;
  customerFlockId: string;
}
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="imApp.flockRelation.home.createOrEditLabel">
              <Translate contentKey="imApp.flockRelation.home.createOrEditLabel">Create or edit a FlockRelation</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : flockRelationEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput id="flock-relation-customer" type="select" className="form-control" name="customer.id">
                    <option value="" key="0" />
                    {customers
                ...
                <AvGroup>
                  ...
                  <AvInput id="flock-relation-customerFlock" type="select" className="form-control" name="customerFlock.id">
                    <option value="" key="0" />
                    {customerFlocks
...
const mapStateToProps = (storeState: IRootState) => ({
  ...
  updateSuccess: storeState.flockRelation.updateSuccess
});
