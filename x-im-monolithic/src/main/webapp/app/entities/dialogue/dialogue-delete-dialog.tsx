...
import { getEntity, deleteEntity } from './dialogue.reducer';
...
export class DialogueDeleteDialog extends React.Component<IDialogueDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.dialogueEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="imApp.dialogue.delete.question">
          <Translate contentKey="imApp.dialogue.delete.question" interpolate={{ id: dialogueEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-dialogue" color="danger" onClick={this.confirmDelete}>
