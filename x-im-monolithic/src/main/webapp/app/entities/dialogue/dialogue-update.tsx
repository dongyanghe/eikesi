    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="imApp.dialogue.home.createOrEditLabel">
              <Translate contentKey="imApp.dialogue.home.createOrEditLabel">Create or edit a Dialogue</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
...
const mapStateToProps = (storeState: IRootState) => ({
  ...
  updateSuccess: storeState.dialogue.updateSuccess
});
