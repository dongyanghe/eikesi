...
import { getEntities } from './history-message.reducer';
...
export type IHistoryMessageState = IPaginationBaseState;
    ...
    return (
      <div>
        <h2 id="history-message-heading">
          <Translate contentKey="imApp.historyMessage.home.title">History Messages</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="imApp.historyMessage.home.createLabel">Create new History Message</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('content')}>
                  <Translate contentKey="imApp.historyMessage.content">Content</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('status')}>
                  <Translate contentKey="imApp.historyMessage.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('createdDate')}>
                  <Translate contentKey="imApp.historyMessage.createdDate">Created Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('createdId')}>
                  <Translate contentKey="imApp.historyMessage.createdId">Created Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('targetDate')}>
                  <Translate contentKey="imApp.historyMessage.targetDate">Target Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('targetId')}>
                  <Translate contentKey="imApp.historyMessage.targetId">Target Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
