    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="manageGatewayApp.customerFlock.home.createOrEditLabel">
              <Translate contentKey="manageGatewayApp.customerFlock.home.createOrEditLabel">Create or edit a CustomerFlock</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
