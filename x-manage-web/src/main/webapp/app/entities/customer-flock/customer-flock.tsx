    ...
    return (
      <div>
        <h2 id="customer-flock-heading">
          <Translate contentKey="manageGatewayApp.customerFlock.home.title">Customer Flocks</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="manageGatewayApp.customerFlock.home.createLabel">Create new Customer Flock</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('manageGatewayApp.customerFlock.home.search')}
                  />
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('name')}>
                  <Translate contentKey="manageGatewayApp.customerFlock.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('py')}>
                  <Translate contentKey="manageGatewayApp.customerFlock.py">Py</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('pinYin')}>
                  <Translate contentKey="manageGatewayApp.customerFlock.pinYin">Pin Yin</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('imageUrl')}>
                  <Translate contentKey="manageGatewayApp.customerFlock.imageUrl">Image Url</Translate> <FontAwesomeIcon icon="sort" />
                </th>
