...
import { getSearchEntities, getEntities } from './current-message.reducer';
    ...
    return (
      <div>
        <h2 id="current-message-heading">
          <Translate contentKey="manageGatewayApp.currentMessage.home.title">Current Messages</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="manageGatewayApp.currentMessage.home.createLabel">Create new Current Message</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('manageGatewayApp.currentMessage.home.search')}
                  />
