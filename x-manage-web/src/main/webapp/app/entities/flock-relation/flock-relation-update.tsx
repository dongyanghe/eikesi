    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="manageGatewayApp.flockRelation.home.createOrEditLabel">
              <Translate contentKey="manageGatewayApp.flockRelation.home.createOrEditLabel">Create or edit a FlockRelation</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
