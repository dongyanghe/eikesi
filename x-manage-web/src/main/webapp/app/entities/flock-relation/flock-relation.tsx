    ...
    return (
      <div>
        <h2 id="flock-relation-heading">
          <Translate contentKey="manageGatewayApp.flockRelation.home.title">Flock Relations</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="manageGatewayApp.flockRelation.home.createLabel">Create new Flock Relation</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('manageGatewayApp.flockRelation.home.search')}
                  />
