...
export interface IHistoryMessageDetailProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="manageGatewayApp.historyMessage.detail.title">HistoryMessage</Translate> [<b>
              {historyMessageEntity.id}
            </b>]
          </h2>
          <dl className="jh-entity-details">
            <dt>
              <span id="content">
                <Translate contentKey="manageGatewayApp.historyMessage.content">Content</Translate>
              </span>
              <UncontrolledTooltip target="content">
                <Translate contentKey="manageGatewayApp.historyMessage.help.content" />
              </UncontrolledTooltip>
            </dt>
            <dd>{historyMessageEntity.content}</dd>
            <dt>
              <span id="status">
                <Translate contentKey="manageGatewayApp.historyMessage.status">Status</Translate>
              </span>
              <UncontrolledTooltip target="status">
                <Translate contentKey="manageGatewayApp.historyMessage.help.status" />
              </UncontrolledTooltip>
            </dt>
            ...
            <dt>
              ...
              <UncontrolledTooltip target="createdDate">
                <Translate contentKey="manageGatewayApp.historyMessage.help.createdDate" />
              </UncontrolledTooltip>
            </dt>
            <dd>
            ...
            <dt>
              <span id="createdId">
                <Translate contentKey="manageGatewayApp.historyMessage.createdId">Created Id</Translate>
              </span>
              <UncontrolledTooltip target="createdId">
                <Translate contentKey="manageGatewayApp.historyMessage.help.createdId" />
              </UncontrolledTooltip>
            </dt>
            <dd>{historyMessageEntity.createdId}</dd>
            <dt>
              <span id="targetDate">
                <Translate contentKey="manageGatewayApp.historyMessage.targetDate">Target Date</Translate>
              </span>
              <UncontrolledTooltip target="targetDate">
                <Translate contentKey="manageGatewayApp.historyMessage.help.targetDate" />
              </UncontrolledTooltip>
            </dt>
            <dd>
            ...
            <dt>
              <span id="targetId">
                <Translate contentKey="manageGatewayApp.historyMessage.targetId">Target Id</Translate>
              </span>
              <UncontrolledTooltip target="targetId">
                <Translate contentKey="manageGatewayApp.historyMessage.help.targetId" />
              </UncontrolledTooltip>
            </dt>
