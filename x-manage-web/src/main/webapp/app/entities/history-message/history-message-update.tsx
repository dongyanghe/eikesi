    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="manageGatewayApp.historyMessage.home.createOrEditLabel">
              <Translate contentKey="manageGatewayApp.historyMessage.home.createOrEditLabel">Create or edit a HistoryMessage</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
