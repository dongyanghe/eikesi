...
import { getEntity, updateEntity, createEntity, reset } from './customer-relation.reducer';
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="manageGatewayApp.customerRelation.home.createOrEditLabel">
              <Translate contentKey="manageGatewayApp.customerRelation.home.createOrEditLabel">Create or edit a CustomerRelation</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : customerRelationEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="remarkNameLabel" for="remarkName">
                    <Translate contentKey="manageGatewayApp.customerRelation.remarkName">Remark Name</Translate>
                  </Label>
                  <AvField
                  ...
                  <UncontrolledTooltip target="remarkNameLabel">
                    <Translate contentKey="manageGatewayApp.customerRelation.help.remarkName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="pyLabel" for="py">
                    <Translate contentKey="manageGatewayApp.customerRelation.py">Py</Translate>
                  </Label>
                  <AvField
                  ...
                  <UncontrolledTooltip target="pyLabel">
                    <Translate contentKey="manageGatewayApp.customerRelation.help.py" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="pinYinLabel" for="pinYin">
                    <Translate contentKey="manageGatewayApp.customerRelation.pinYin">Pin Yin</Translate>
                  </Label>
                  <AvField
                  ...
                  <UncontrolledTooltip target="pinYinLabel">
                    <Translate contentKey="manageGatewayApp.customerRelation.help.pinYin" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="typeLabel" for="type">
                    <Translate contentKey="manageGatewayApp.customerRelation.type">Type</Translate>
                  </Label>
                  <AvField
                  ...
                  <UncontrolledTooltip target="typeLabel">
                    <Translate contentKey="manageGatewayApp.customerRelation.help.type" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="createdDateLabel" for="createdDate">
                    <Translate contentKey="manageGatewayApp.customerRelation.createdDate">Created Date</Translate>
                  </Label>
                  <AvInput
                  ...
                  <UncontrolledTooltip target="createdDateLabel">
                    <Translate contentKey="manageGatewayApp.customerRelation.help.createdDate" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label for="customer.firstName">
                    <Translate contentKey="manageGatewayApp.customerRelation.customer">Customer</Translate>
                  </Label>
                  <AvInput
