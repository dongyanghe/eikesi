    ...
    return (
      <div>
        <h2 id="customer-relation-heading">
          <Translate contentKey="manageGatewayApp.customerRelation.home.title">Customer Relations</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="manageGatewayApp.customerRelation.home.createLabel">Create new Customer Relation</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('manageGatewayApp.customerRelation.home.search')}
                  />
