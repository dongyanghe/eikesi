...
public interface CC {
    ...
    static Config load() {
        ...
        String defaultPath = "F:\\NullWorkpase\\mPush-group\\mpush\\mpush-boot\\src\\main\\resources\\mpush.conf";
//        config.atPath(defaultPath);
//        config.atPath(custom_conf);
//        config.atKey(custom_conf);
