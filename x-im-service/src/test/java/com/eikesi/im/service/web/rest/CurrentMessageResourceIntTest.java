...
import com.eikesi.im.service.service.CurrentMessageService;
...
import com.eikesi.im.service.web.rest.errors.ExceptionTranslator;
...
import static com.eikesi.im.service.web.rest.TestUtil.createFormattingConversionService;
...
public class CurrentMessageResourceIntTest {
    ...
    public void updateCurrentMessage() throws Exception {
        ...
        CurrentMessage updatedCurrentMessage = currentMessageRepository.findOne(currentMessage.getId());
    ...
    public void updateNonExistingCurrentMessage() throws Exception {
        ...
        // Validate the CurrentMessage in the database
        List<CurrentMessage> currentMessageList = currentMessageRepository.findAll();
        assertThat(currentMessageList).hasSize(databaseSizeBeforeUpdate + 1);
    }
