package com.eikesi.im.message.config.timezone;

import com.eikesi.im.message.ImMessageServerApp;
import com.eikesi.im.message.config.SecurityBeanOverrideConfiguration;
import com.eikesi.im.message.repository.timezone.DateTimeWrapper;
import com.eikesi.im.message.repository.timezone.DateTimeWrapperRepository;
...
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, ImMessageServerApp.class})
